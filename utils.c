...
#ifdef HAVE_STATX
void copy_statx_to_stat_time(struct statx_timestamp *stx, struct timespec *st)
{
...
int mkdir_all(char *folder_path)
{
...
void local_xattr_db_init(const char *db_parent_dir)
{
